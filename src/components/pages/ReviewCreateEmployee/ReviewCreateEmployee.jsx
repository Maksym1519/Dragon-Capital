import d from "./reviewCreateEmployee.module.scss";
    ...
    <div className={d.wrapper}>
      ...
      <div className={d.background}>
        <div className={d.container}>
          ...
          <div className={d.buttons__wrapper}>
            <Button218 text={<Text15700 text='Затвердити' color='#fff'/>} bg='#277D59'/>
            <Button310 text={<Text15700 text='Відправити на доопрацювання' color='#EE3424'/>} bg='rgba(238, 52, 36, 0.06)'/>
          </div>
        </div>
        <Footer />
      </div>
